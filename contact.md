...
<section class="section-block">
  <div class="section-heading">
    ...
    <h2>I am open to meaningful academic and professional conversations</h2>
  </div>
  <div class="contact-grid">
    <article class="contact-card">
      <h3>Email</h3>
      <p>For portfolio feedback, academic discussion, or opportunities, email is the best way to reach me directly.</p>
      <a class="primary-link" href="mailto:gondalasim665@gmail.com">gondalasim665@gmail.com</a>
    </article>
    <article class="contact-card">
      <h3>GitHub</h3>
      <p>You can also view my work and connect with me through my GitHub profile and portfolio repository.</p>
      <a class="secondary-link" href="https://github.com/asim-raza665">github.com/asim-raza665</a>
    </article>
    <article class="contact-card">
      <h3>Academic Base</h3>
